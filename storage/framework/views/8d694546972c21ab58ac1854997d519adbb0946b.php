...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $('#dataTable').DataTable({
            ...
            ajax: {
                type: 'GET',
                url: '<?php echo e(route('admin.smelting.dataChange')); ?>',
                data: {
                    wo_id: $('#wo-id').val(),
                }
            },
    ...
    <script>
        ...
        function addRow(obj) {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '<?php echo e(route('admin.smelting.addSmeltingChange')); ?>',
                data: {
                    wo_id: obj.wo_id,
                    weight: obj.weight,
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '<?php echo e(route('admin.smelting.getDataWoChange')); ?>',
            data: {
                wo_id: $('#wo-id').val(),
                _token: '<?php echo e(csrf_token()); ?>'
            },
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\resources\views\admin\smelting\leburan_change_form.blade.php ENDPATH**/ ?>