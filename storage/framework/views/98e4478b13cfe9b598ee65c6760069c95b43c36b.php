        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline <?php echo e($workorder->workorderHasTpm ? 'collapsed-card' : ''); ?>">
                            <div class="card-header">
                                <h5 class="card-title">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('workorderHasTpm.store', $workorder)); ?>" method="post" id="tpmForm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <select name="visual_barang_awal" class="form-control" id="">
                                                                ...
                                                                <option value="ok" <?php if(old('visual_barang_awal') == 'ok' || $workorder->workorderHasTpm?->visual_barang_awal == 'ok'): ?> selected <?php endif; ?>>OK</option>
                                                                <option value="ng" <?php if(old('visual_barang_awal') == 'ng' || $workorder->workorderHasTpm?->visual_barang_awal == 'ng'): ?> selected <?php endif; ?>>NG</option>
                                                            </select>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <select name="kelurusan_awal" id="" class="form-control">
                                                                <option value="">-- Select one --</option>
                                                                <option value="ok" <?php if(old('kelurusan_awal') == 'ok' || $workorder->workorderHasTpm?->kelurusan_awal == 'ok'): ?> selected <?php endif; ?>>OK</option>
                                                                <option value="ng" <?php if(old('kelurusan_awal') == 'ng' || $workorder->workorderHasTpm?->kelurusan_awal == 'ng'): ?> selected <?php endif; ?>>NG</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <select name="visual_barang_akhir" id="" class="form-control">
                                                                <option value="">-- Select one --</option>
                                                                <option value="ok" <?php if(old('visual_barang_akhir') == 'ok' || $workorder->workorderHasTpm?->visual_barang_akhir == 'ok'): ?> selected <?php endif; ?>>OK</option>
                                                                <option value="ng" <?php if(old('visual_barang_akhir') == 'ng' || $workorder->workorderHasTpm?->visual_barang_akhir == 'ng'): ?> selected <?php endif; ?>>NG</option>
                                                            </select>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <select name="kelurusan_akhir" id="" class="form-control">
                                                                <option value="">-- Select one --</option>
                                                                <option value="ok" <?php if(old('kelurusan_akhir') == 'ok' || $workorder->workorderHasTpm?->kelurusan_akhir == 'ok'): ?> selected <?php endif; ?>>OK</option>
                                                                <option value="ng" <?php if(old('kelurusan_akhir') == 'ng' || $workorder->workorderHasTpm?->kelurusan_akhir == 'ng'): ?> selected <?php endif; ?>>NG</option>
                                                                >NG</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-8"></div>
                                        <div class="col-4">
                                            <button class="form-control btn btn-primary" id="tpm-form-button"><?php echo e($workorder->workorderHasTpm ? 'Update' : 'Submit'); ?></button>
                                        </div>
                                    </div>
                                </form>
                                <?php if($workorder->workorderHasTpm): ?>
                                    <form action="<?php echo e(route('workorderHasTpm.approve', $workorder)); ?>" method="post" id="approve-tpm-form">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-2">
                                            <div class="col-8"></div>
                                            <div class="col-4">
