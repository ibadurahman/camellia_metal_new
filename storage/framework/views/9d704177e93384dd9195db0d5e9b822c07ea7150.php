...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Diameter Tolerance (+mm)" value="<?php echo e(old('tolerance_plus')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Diameter Tolerance (-mm)" value="<?php echo e(old('tolerance_minus')); ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input id="length-tolerance-plus" name="length_tolerance_plus" type="text"
                                                class="form-control <?php $__errorArgs = ['length_tolerance_plus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Length Tolerance (+mm)" value="<?php echo e(old('length_tolerance_plus')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input id="length-tolerance-minus" name="length_tolerance_minus" type="text"
                                                class="form-control <?php $__errorArgs = ['length_tolerance_minus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Length Tolerance (-mm)" value="<?php echo e(old('length_tolerance_minus')); ?>">
