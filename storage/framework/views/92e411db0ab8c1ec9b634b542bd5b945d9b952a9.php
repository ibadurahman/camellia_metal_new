                        ...
                        <div class="card card-primary card-outline collapsed-card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    ...
                                    <?php if($workorder->workorderHasTpm): ?>
                                        <span class="badge badge-success mr-2">Done</span>
                                    <?php endif; ?>
                                    <?php if($workorder->workorderHasTpm?->approved_by): ?>
                            ...
                            <div class="card-body">
                                <?php if($workorder->workorderHasTpm): ?>
                                            ...
                                            <table class="table table-hover table-sm table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center align-middle">Awal</td>
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->visual_barang_awal == 'ok'): ?>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->kelurusan_awal == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        <td class="text-center align-middle">Akhir</td>
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->visual_barang_akhir == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->kelurusan_akhir == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                            ...
                                            <table class="table table-hover table-sm table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->pre_straightening_putaran_roller_berputar == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->pre_straightening_kondisi_produk_tidak_keluar_jalur == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->kondisi_pelumas == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Berputar</td>
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->straightening_putaran_roller_berputar == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Tidak Keluar Jalur</td>
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->straightening_kondisi_produk_tidak_keluar_jalur == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        <td class="text-center align-middle" rowspan="<?php echo e($workorder->machine->name == 'IB8' ? '7' : '3'); ?>">Cutting</td>
                                                    ...
                                                    <?php if($workorder->machine->name != 'IB8'): ?>
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->polishing_tidak_cacat == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <?php if($workorder->machine->name != 'S2B'): ?>
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Lancar</td>
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->polishing_kondisi_pelumas_lancar == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php if($workorder->workorderHasTpm?->polishing_penutup_oli_tertutup == 'ok'): ?>
                                                                <span class="badge badge-success">OK</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-danger">NG</span>
                                                            <?php endif; ?>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            <?php if($workorder->workorderHasTpm?->hasil_setting == 'ok'): ?>
                                                <span class="badge badge-success">OK</span>
                                            <?php else: ?>
                                                <span class="badge badge-danger">NG</span>
                                            <?php endif; ?>
