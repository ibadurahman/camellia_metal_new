...
unset($__errorArgs, $__bag); ?>" placeholder="Size 1" value="<?php echo e(old('size_1')); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Size 2" value="<?php echo e(old('size_2')); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(old('shape') == 'Round'): ?>
                                            selected                                            
                                        <?php endif; ?>>Round</option>
                                        <option id="shape-square" value="Square"
                                        <?php if(old('shape') == 'Square'): ?>
                                            selected                                            
                                        <?php endif; ?>>Square</option>  
                                        <option id="shape-hexagon" value="Hexagon"
                                        <?php if(old('shape') == 'Hexagon'): ?>
                                            selected                                            
                                        <?php endif; ?>>Hexagon</option>  
                                    </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Straightness Standard" value="<?php echo e(old('straightness_standard')); ?>">
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\resources\views\admin\customer\create.blade.php ENDPATH**/ ?>