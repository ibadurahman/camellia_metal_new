<button href="<?php echo e(route('admin.smelting.destroy', $model)); ?>" class="btn btn-danger" id="delete">Delete</button>
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: `<?php echo e(route('admin.smelting.update', $model)); ?>`,
                    data: {
...
<?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\resources\views\admin\smelting\action.blade.php ENDPATH**/ ?>