                            ...
                            <div class="card-body">
                                <?php if($isTPMCompleted): ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->kode_dies_awal); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_dies_awal); ?>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_aktual_setelah_dies_awal); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_aktual_setelah_polishing_awal); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->kode_dies_akhir); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_dies_akhir); ?>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_aktual_setelah_dies_akhir); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->diameter_aktual_setelah_polishing_akhir); ?>
                                            ...
                                            <table class="table table-hover table-sm table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center align-middle">Awal</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->visual_barang_awal); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->kelurusan_awal); ?>
                                                    ...
                                                    <tr>
                                                        <td class="text-center align-middle">Akhir</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->visual_barang_akhir); ?>

                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->kelurusan_akhir); ?>
                                            ...
                                            <table class="table table-hover table-sm table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->pre_straightening_putaran_roller_berputar)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->pre_straightening_kondisi_produk_tidak_keluar_jalur)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ampere_impeller_1); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ampere_impeller_2); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ampere_impeller_3); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ampere_impeller_4); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2"><?php echo e($workorder->machine->name); ?> : 
                                                            ...
                                                            <?php endif; ?></td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->speed_motor); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_slide); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->kondisi_pelumas)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Berputar</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->straightening_putaran_roller_berputar)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Tidak Keluar Jalur</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->straightening_kondisi_produk_tidak_keluar_jalur)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->cutting_panjang); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_in); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_out); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_out_cutter_5); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_out_cutter_6); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_out_cutter_7); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->ukuran_dies_cutting_out_cutter_9); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->polishing_tidak_cacat)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->polishing_ukuran_plat_kuningan); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->polishing_ampere_motor); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e($workorder->workorderHasTpm?->polishing_ampere_motor_s2b); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">Lancar</td>
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->polishing_kondisi_pelumas_lancar)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->polishing_penutup_oli_tertutup)); ?>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            <?php echo e(strtoupper($workorder->workorderHasTpm?->hasil_setting)); ?>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-3">
                                            <?php echo e($workorder->workorderHasTpm?->quality_control); ?>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            <?php echo e($workorder->workorderHasTpm?->catatan); ?>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-6 row">
                                            ...
                                            <div class="col-6 justify-center">
                                                ...
                                                <p class="ml-2 mb-1 my-auto"><?php echo e($workorder->workorderHasTpm?->checked_by); ?></p>
                                            </div>
                                            <div class="col-3">
                                                <p class="ml-2 mb-1 my-auto">Created by:</p>
                                                <p class="ml-2 mb-1 my-auto"><?php echo e($workorder->workorderHasTpm?->createdBy->name); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card card-outline card-primary">
                            ...
                            <div class="card-body">
                                <p><?php echo e($workorder->production_remarks); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $('#workorder-details').on('click', function() {
        Swal.fire({
            ...
            html: '<div class="row">' +
                ...
                '<span class="description-text float-left">Process Start: <?php echo e($workorder->process_start); ?></span><br>' +
                '<span class="description-text float-left">Process End: <?php echo e($workorder->process_end); ?></span><br>' +
                '<hr>' +
                ...
                '<span class="description-text float-left">Diameter Tolerance: <?php echo e((substr($workorder->tolerance_plus, 0, 1) !== '-' ? '+' : '') . $workorder->tolerance_plus); ?> mm, <?php echo e($workorder->tolerance_minus); ?> mm</span><br>' +
                '<span class="description-text float-left">Length Tolerance: <?php echo e((is_numeric($workorder->length_tolerance_plus) && is_numeric($workorder->length_tolerance_minus) ? "(".$model->length_tolerance_plus.",".$model->length_tolerance_minus.")": "-")); ?></span><br>' +
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\resources\views/user/workorder/details.blade.php ENDPATH**/ ?>