    ...
    <script>
        ...
        function update_sorting() {
            ...
            let waitingTable = $('#waiting-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": '<?php echo e(route('workorder.showWaiting')); ?>',
                    "data": {
            ...
            $('#onprocess-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": '<?php echo e(route('workorder.showOnProcess')); ?>',
                    "data": {
                        "machine": $('#machine-selector').val()
                    }
                },
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\resources\views\operator\schedule\index.blade.php ENDPATH**/ ?>