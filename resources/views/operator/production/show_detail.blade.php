    ...
    $('#workorder-details').on('click', function() {
        Swal.fire({
            ...
            html: '<div class="row">' +
                ...
                '<span class="description-text float-left">Length Tolerance: {{ (is_numeric($workorder->length_tolerance_plus) && is_numeric($workorder->length_tolerance_minus) ? "(".$workorder->length_tolerance_plus.",".$workorder->length_tolerance_minus.")": "-")}}</span><br>' +
