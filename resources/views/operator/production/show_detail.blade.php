                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="text" class="form-control" name="kode_dies_awal">
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="diameter_dies_awal">
                                                        </td>
                                                        <td class="text-center align-middle">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control"
                                                                name="diameter_aktual_setelah_dies_awal">
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control"
                                                                name="diameter_aktual_setelah_polishing_awal">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center align-middle">Akhir</td>
                                                        <td class="text-center align-middle">
                                                            <input type="text" class="form-control" name="kode_dies_akhir">
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="diameter_dies_akhir">
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <span>Lihat tabel No:</span><br>
                                                            <span>STD.PP.25-MTD-001</span>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control"
                                                                name="diameter_aktual_setelah_dies_akhir">
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control"
                                                                name="diameter_aktual_setelah_polishing_akhir">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-hover table-sm table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ampere_impeller_1">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ampere_impeller_2">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ampere_impeller_3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle" colspan="2">30 - 40 A</td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ampere_impeller_4">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="speed_motor">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_slide">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="cutting_panjang">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_in">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_out">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_out_cutter_5">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_out_cutter_6">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_out_cutter_7">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="ukuran_dies_cutting_out_cutter_9">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="polishing_ukuran_plat_kuningan">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="polishing_ampere_motor">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center align-middle" colspan="2">S2B <u><</u> 20A</td>
                                                        <td class="text-center align-middle">
                                                            <input type="number" class="form-control" name="polishing_ampere_motor_s2b">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" value="ok" type="radio" name="hasil_setting" id="hasilSettingOK">
                                                <label class="form-check-label" for="hasilSettingOK">
                                                    OK
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" value="ng" type="radio" name="hasil_setting" id="hasilSettingNG">
