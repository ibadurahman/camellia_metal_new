    ...
    $('#workorder-details').on('click', function() {
        Swal.fire({
            ...
            html: '<div class="row">' +
                ...
                '<span class="description-text float-left">Length Tolerance: {{ (is_numeric($workorder->length_tolerance_plus) && is_numeric($workorder->length_tolerance_minus) ? "(".$model->length_tolerance_plus.",".$model->length_tolerance_minus.")": "-")}}</span><br>' +
