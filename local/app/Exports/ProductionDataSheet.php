        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use ($outsideBorder, $productions) {
                ...
                for ($i=0; $i < count($productions); $i++) {
                    ...
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->diameter_ujung);
                    $j++;
                    $event->sheet->setCellValue('B'.$j, 'Diameter Tengah:');
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->diameter_tengah);
                    $j++;
                    $event->sheet->setCellValue('B'.$j, 'Diameter Ekor:');
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->diameter_ekor);
                    $j++;
                    ...
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->panjang_aktual);
                    $j++;
                    $event->sheet->setCellValue('B'.$j, 'Berat FG:');
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->berat_fg);
                    $j++;
                    $event->sheet->setCellValue('B'.$j, 'QTY (Pcs):');
                    $event->sheet->setCellValue('C'.$j, $productions[$i]->pcs_per_bundle);
                    $j++;
                    ...
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->diameter_ujung);
                    $l++;
                    $event->sheet->setCellValue('E'.$l, 'Diameter Tengah:');
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->diameter_tengah);
                    $l++;
                    $event->sheet->setCellValue('E'.$l, 'Diameter Ekor:');
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->diameter_ekor);
                    $l++;
                    ...
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->panjang_aktual);
                    $l++;
                    $event->sheet->setCellValue('E'.$l, 'Berat FG:');
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->berat_fg);
                    $l++;
                    $event->sheet->setCellValue('E'.$l, 'QTY (Pcs):');
                    $event->sheet->setCellValue('F'.$l, $productions[$i]->pcs_per_bundle);
                    $l++;
