                                                ...
                                                <table class="table table-hover table-sm table-bordered table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center align-middle" colspan="2">MESIN {{ $workorder->machine->name }} : 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center align-middle" colspan="2">MESIN {{ $workorder->machine->name }} : <u>></u> 2mm dari diameter F/G</td>
                                                            <td class="text-center align-middle">
