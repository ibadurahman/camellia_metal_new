    ...
    $('#workorder-details').on('click', function() {
        Swal.fire({
            ...
            html: '<div class="row">' +
                ...
                '<span class="description-text float-left">Diameter Tolerance: {{ (substr($workorder->tolerance_plus, 0, 1) !== '-' ? '+' : '') . $workorder->tolerance_plus }} mm, {{ $workorder->tolerance_minus }} mm</span><br>' +
                '<span class="description-text float-left">Length Tolerance: {{ (is_numeric($workorder->length_tolerance_plus) && is_numeric($workorder->length_tolerance_minus) ? $workorder->length_tolerance_plus." MM,".$workorder->length_tolerance_minus." MM": "-")}}</span><br>' +
