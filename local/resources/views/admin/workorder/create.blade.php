                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.workorder.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="">Quantity (Bundle)</label>
                                    <input id="supplier-qty-bundle" name="bb_qty_bundle" type="text" class="form-control @error('bb_qty_bundle') is-invalid @enderror" placeholder="Quantity (Bundle)" value="{{old('bb_qty_bundle')}}">
                                    @error('bb_qty_bundle')
                                        <span class="text-danger help-block">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="">Size (diameter(mm) x length(mm))</label>
                                    <div class="row">
                                        <div class="col-5">
                                ...
                                <div class="form-group">
                                    <span class="text-muted help-block">Estimated Planned Output: <span id="estimated-qty-planned"></span> Pcs</span>
                                </div>
                                <div class="form-group">
                                    <div class="row">
    ...
    <script>
        $(function(){
            ...
            function recalculate()
            {
                ...
                $('#estimated-qty-planned').html(calculateQtyPlanned($('#supplier-qty-kg').val(),$('#customer-shape').val()));
            }
            ...
            function calculatePcsPerBundle(weightVal=0,shape=null)
            {
                ...
                $.ajax({
                    ...
                    success:function(response){
                        result = Math.round(weightVal/diameter/diameter/panjang/response*1000);
