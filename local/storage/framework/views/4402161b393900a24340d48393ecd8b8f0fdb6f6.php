                                ...
                                <div class="col-6">
                                    <select name="" id="machine-selector" onchange="update_sorting()"
                                        ...
                                        <?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($machine->ip_address == request()->ip() || auth()->user()->hasRole('supervisor|owner|super-admin')): ?>
                                                <option value="<?php echo e($machine->id); ?>" selected><?php echo e($machine->name); ?></option>
                                            <?php endif; ?>
    ...
    <script>
        ...
        function update_sorting() {
            ...
            $('#onprocess-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": '<?php echo e(route('operator.production.showOnProcess')); ?>',
                    "data": {
...
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2. Dokumen Ibad\11. Personal Business\Projects\2. Running\Camellia Maintenance\test_env\local\resources\views/operator/production/index.blade.php ENDPATH**/ ?>